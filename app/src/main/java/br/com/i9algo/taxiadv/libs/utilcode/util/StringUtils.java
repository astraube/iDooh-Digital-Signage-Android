...
public final class StringUtils {
    ...
    public static List<String> unflatString(String concatenatedString) {
        String[]images = concatenatedString.split(";");
        List<String> unflattenedImages = new ArrayList<>();
        for (String s : images){
            unflattenedImages.add(s);
        }
        return unflattenedImages;
    }

    public static String substringBackspace(String text, String replacement) {
        return text.trim().replace(" ", replacement);
    }

    public static String getFlatStrings(List<String> strings) {
        String flatUrls = "";
        for (String image : strings){
            if (flatUrls.isEmpty()){
                flatUrls = image;
            }else{
                flatUrls = flatUrls + ";" + image;
            }
        }
        return flatUrls;
    }
    ...
    public static String deAccent(String str) {
        String text = Normalizer.normalize(str, Normalizer.Form.NFKD)
