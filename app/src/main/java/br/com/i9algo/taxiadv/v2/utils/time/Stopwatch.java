 ...
 *
 * Apenas conta o tempo de uma posicao cronologica a outra
 *
 * EX: init(11:00) ~ fim(11:10) = SegundosPercorridos(600)
 */
public class Stopwatch {

    private long startThreadMillis = 0;
    private long startRealtimeMillis = 0;
    ...
    public Stopwatch(boolean autoInit) {
        if (autoInit)
            reset();
    }
    ...
    public long getElapsedTimeLong() {
        return (long)getElapsedTime().getElapsedRealtimeMillis();
    }
