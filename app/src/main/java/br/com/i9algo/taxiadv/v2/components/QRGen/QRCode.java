package br.com.i9algo.taxiadv.v2.components.QRGen;
...
import br.com.i9algo.taxiadv.v2.components.QRGen.exception.QRGenerationException;
import br.com.i9algo.taxiadv.v2.components.QRGen.image.ImageType;
import br.com.i9algo.taxiadv.v2.components.QRGen.scheme.Schema;
...
public class QRCode extends AbstractQRCode {
     ...
     * {@link AbstractQRCode#to(ImageType)} e.g.
