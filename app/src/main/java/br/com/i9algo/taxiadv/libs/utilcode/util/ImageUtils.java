...
public final class ImageUtils {
    ...
    /**
     * Juntar dois bitmaps em um
     *
     * @param orientation LinearLayout.VERTICAL | LinearLayout.HORIZONTAL
     * @param c
     * @param s
     * @return
     */
    public static Bitmap combineBitmaps(@NonNull int orientation, @NonNull Bitmap c, @NonNull Bitmap s) {
        Bitmap cs = null;
        ...
        if (orientation == LinearLayout.VERTICAL) {
            ...
            Log.e("combineImages", "Orientacao invalida");
            return null;
        }
        cs = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888);
        Canvas comboImage = new Canvas(cs);
        comboImage.drawBitmap(c, 0f, 0f, null);
        comboImage.drawBitmap(s, left, top, null);
        return cs;
    }

    /**
     * Converter Array de "View" em Array de "Bitmap"
     *
     * @param contents
     */
    public static List<Bitmap> toBitmapList(View... contents) {
        List<Bitmap> bitmaps = new ArrayList<Bitmap>();

        for (int a = 0; a < contents.length; a++) {
            // Converter Views para Bitmaps
            contents[a].setDrawingCacheEnabled(true);
            Bitmap b = view2Bitmap(contents[a]);
            bitmaps.add(b);
        }
        return bitmaps;
    }
